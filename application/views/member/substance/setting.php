            ...
            <div class="box-showing">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="float-end">
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1" onclick="set_number_input_text('minus','ph_inj','float')"><i class="fa fa-minus fa-lg"></i></span>
                                <input type="text" aria-label="Username" id="ph_inj" value="<?= number_format($info[0]->ph_inj, 2) ?> Sec." style="width: 90px; text-align : center">
                                <span class="input-group-text" id="basic-addon2" onclick="set_number_input_text('plus','ph_inj','float')"><i class="fa fa-plus fa-lg"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-showing">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="float-end">
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1" onclick="set_number_input_text('minus','orp_inj','float')"><i class="fa fa-minus fa-lg"></i></span>
                                ...
                                <span class="input-group-text" id="basic-addon2" onclick="set_number_input_text('plus','orp_inj','float')"><i class="fa fa-plus fa-lg"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="float-end">
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1" onclick="set_number_input_text('minus','orp_freq','float')"><i class="fa fa-minus fa-lg"></i></span>
                                <input type="text" aria-label="Username" id="orp_freq" value="<?= number_format($info[0]->orp_freq, 2) ?> Sec." style="width: 90px; text-align : center">
                                <span class="input-group-text" id="basic-addon2" onclick="set_number_input_text('plus','orp_freq','float')"><i class="fa fa-plus fa-lg"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
